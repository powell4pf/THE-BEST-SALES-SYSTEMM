...
export function Sidebar({ currentPath, onNavigate, collapsed, onToggleCollapsed }: Props) {
  return (
    <aside className={cn('sidebar-panel flex h-full flex-col gap-6 p-4', collapsed && 'collapsed')}>
