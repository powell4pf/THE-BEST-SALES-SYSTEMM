...
export function NotificationsMenu() {
  ...
  return <div ref={containerRef} className="relative z-[100]">
    ...
    {open && <div className="absolute right-0 top-12 z-[100] w-[min(24rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-slate-200 bg-white text-slate-950 shadow-2xl ring-1 ring-slate-950/5 dark:border-white/10 dark:bg-slate-900 dark:text-white">
