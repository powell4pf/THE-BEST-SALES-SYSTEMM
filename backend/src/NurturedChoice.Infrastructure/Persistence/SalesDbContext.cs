...
public class SalesDbContext : DbContext, IUnitOfWork
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Notification>().Property(x => x.Id).HasColumnName("id");
        modelBuilder.Entity<Notification>().Property(x => x.AppUserId).HasColumnName("app_user_id");
        modelBuilder.Entity<Notification>().Property(x => x.DocumentType).HasColumnName("document_type");
        modelBuilder.Entity<Notification>().Property(x => x.DocumentId).HasColumnName("document_id");
        modelBuilder.Entity<Notification>().Property(x => x.Title).HasColumnName("title");
        modelBuilder.Entity<Notification>().Property(x => x.Message).HasColumnName("message");
        modelBuilder.Entity<Notification>().Property(x => x.Route).HasColumnName("route");
        modelBuilder.Entity<Notification>().Property(x => x.ReadAt).HasColumnName("read_at");
        modelBuilder.Entity<Notification>().Property(x => x.CreatedAt).HasColumnName("created_at");
        modelBuilder.Entity<Notification>().Property(x => x.CreatedBy).HasColumnName("created_by");
        modelBuilder.Entity<Notification>().Property(x => x.UpdatedAt).HasColumnName("updated_at");
        modelBuilder.Entity<Notification>().Property(x => x.UpdatedBy).HasColumnName("updated_by");
        modelBuilder.Entity<Notification>().Property(x => x.IsDeleted).HasColumnName("is_deleted");
