...
public sealed record PaymentListItemDto(Guid Id, Guid ParentGroupId, string CustomerName, DateOnly PaymentDate, decimal Amount, string Method, string? Reference, decimal AllocatedAmount);
